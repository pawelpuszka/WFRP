...
**Pomieszczenie pierwsze** 
	...
	**PIWNICA**
	Na dole jest jasno ponieważ świecą się pochodnie. Jest to piwnica do której prowadzi drewniana drabinka. 
	Tutaj także stoi stół i dwie ławy. To pomieszczenie jest większe od tego na górze
	W  kącie po prawej stronie znajduje się również mały ołtarzyk poświęcony Rogatemu Szczurowi. Ołtarzyk zrobiony jest z trzech długich na metr patyków. Są one połączone w trójkąt w taki sposób że końcówki tych patyków zachodzą na siebie. Po środku tego trójkąta leży kilka rzeczy. Stary grzebień, guzik, pęk włosów i dobrej jakości rękawiczka skórzana z haftowanymi złotą nicią ozdobami (jest to rękawiczka Ponurego Wolfa).
	Na jednej ze ścian widoczne kolejne drewniane drzwi. Za drzwiami korytarzyk i po obydwu stronach drzwi, które można otworzyć. W pomieszczeniach po jednej i po drugiej stronie można znaleźć prowizoryczne leża ze słomy, wiadro wypełnione odchodami. pomieszczenia wyglądają jak cele i najwidoczniej ktoś był tutaj przetrzymywany
	Z piwnicy prowadzi dalej widoczny w świetle pochodni korytarz którego dalsze zakamarki nikną w ciemności.
...
[[#OD STRONY KANAŁÓW]]
Tutaj można trafić
- zastraszenie złapanego kultysty, który wyjawia instrukcję dotarcia [[4. Instrukcje kultysty - Kolonia Wandiene]]
Jesteście przy kamieniu przy którym zostawialiście wiadomość.
Idziecie głównym, szerokim kanałem. Towarzyszy wam nieustanny szum płynącej wody, odgłosy szczurów oraz echo niosące metaliczne uderzenia i chrupnięcia z oddali.
Po jakimś czasie mijacie mniejszą odnogę kanału. Drogę przecina wam 2 metrowy ściek który skręca właśnie do tej odnogi.
*Dopiero trzecia odnoga będzie tą prawidłową*
- TEST Percepcja +20 - aby znaleźć symbol trójkąta
- TEST Intuicja, Nawigacja - aby ocenić ile metrów przeszli BG
Znaleźliście wspomnianą przez kultystę odnogę kanału. Po jakichś 20 metrach chodnik kończy się. 
*Jeżeli BG idą dalej*
Brodzicie w ściekach po kolana czując jak różne odpadki i śmieci obijają się od waszych nóg. Ale zaraz dostrzegacie dziwny korytarz który odchodzi pod dużym kątem od tego głównego. Wygląda niemal jakby zawracał.
Ten korytarz jest dosyć wąski. Musicie iść jeden za drugim. Brodzicie nadal w ścieku ale grunt powoli się podnosi aby w końcu wyprowadzić was na chodnik gdzie nie ma już żadnego ścieku. Dochodzicie do końca korytarza. 
Rozglądacie się i widzicie po prawej ciemną wnękę , która wydaje się kończyć ślepym murem.
*Badanie wnęki*
Zaglądasz do wnętrza i widzisz w świetle latarni że za murem jest przejście.
**TEST Wiedza(Inżynieria)** +40 Ta ściana został tutaj niedawno wymurowana. 
Przejście kończy się po dwóch metrach ale trafiacie na **solidne, dębowe drzwi** wyposażone w klamkę i metalowy zamek.



**[[Południowa część Dzielnicy Rzemieślniczej]]** 
**[[#BUDYNEK W DZIELNICY RZEMIEŚLNICZEJ]]**
Jeden z budynków przylegających do placu to siedziba kultu. 
To tutaj BG zostanie przyprowadzony aby spotkać się ze Śliskim Kubą. ^8d54d5

W środku zazwyczaj jest tylko jeden kultysta. To jego posiadłość którą udostępnia na potrzeby kultu.
...
We wnęce jest drabinka sznurkowa.
Wspięcie się po niej doprowadzi BG do drewnianej klapy. Klapa jest zamknięta. ^1adac8

Można ją otworzyć albo siłą (hałas) albo delikatnie podważyć zawiasy.
W budynku jest jeden kultysta ^8a8963
- jeżeli usłyszy BG to schowa się w sypialni i będzie próbował zaatakować BG z zaskoczenia a następnie ucieknie
- jeżeli nie usłyszy to będzie zaskoczony
Głównym celem kultysty będzie ucieczka.
Złapany [[5. Spotkanie z Kubą#^a38091]]