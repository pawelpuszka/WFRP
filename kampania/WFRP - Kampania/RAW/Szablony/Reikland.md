...
image: [[reikland.png]] ### Link to the map image file. Do not add a ! in front of the image  
...
lat: 650 ### To center the map, make this half of the map height.  
...
scale: 0.33333 ### Real units/px (resolution) of your map  
recenter: false  
